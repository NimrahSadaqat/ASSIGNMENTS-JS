...
// var positiveNum = +prompt("Enter a positive number: ");
// document.write("<br>" + "<br>" + "Number: " + positiveNum);
// document.write("<br>" + "Round off value: " + Math.round(positiveNum));
// document.write("<br>" + "Floor value: " + Math.floor(positiveNum));
// document.write("<br>" + "Ceil value: " + Math.ceil(positiveNum));

// 2

// var negativeNum = +prompt("Enter a negative floating point number: ");
// document.write("<br>" + "<br>" + "Number: " + negativeNum);
